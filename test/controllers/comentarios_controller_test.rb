...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { autor: @comentario.autor, conteudo: @comentario.conteudo, post_id: @comentario.post_id, text: @comentario.text }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { autor: @comentario.autor, conteudo: @comentario.conteudo, post_id: @comentario.post_id, text: @comentario.text }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
